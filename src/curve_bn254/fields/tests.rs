...
use crate::curve_bn254::fields::*;

use ark_algebra_test_templates::fields::*;
use ark_ff::{
    BigInteger, BigInteger256, FftField, FftParameters, Field, Fp6Parameters, FpParameters, One,
...
fn test_fq_ordering() {
    ...
    for i in 0..ITERATIONS {
        assert!(
            Fq::from(BigInteger256::from((i + 1) as u64)) > Fq::from(BigInteger256::from(i as u64))
        );
    }
}
